...
public class Rifle : WeaponBehavior
{
    ...
    {
        base.Setup(data);
        iWeaponHandle_ = new IRifle();
        iWeaponHandle_.Setup(this);

        BYPool pool = new BYPool();
        pool.name_pool = NamePool.BL_ASSAULT;
        pool.total = clipSize;
