...
public class MissionViewSnap : MonoBehaviour,IBeginDragHandler, IEndDragHandler
    {
        /// <summary>
...
public void OnEndDrag(PointerEventData data)
{
    ...
    if (_isDragging)
    {
        ...
        if (jumpToIndex != -1)
        {
            ...
            scroller.JumpToDataIndex(Mathf.Clamp(jumpToIndex, 0, MaxDataElements - 1),0,0.125f,true, tweenType: snapTweenType, tweenTime: snapTweenTime);
        }
    }
}
}